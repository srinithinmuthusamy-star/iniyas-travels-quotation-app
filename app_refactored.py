...
with st.form("billing_form"):
    ...
    with right_col:
        ...
        bank_name = st.text_input("Bank Name", value="IOB")
        account_name = st.text_input("Account Name", value="INIYAS TRAVELS")
        account_number = st.text_input("Account Number", value="009102000007035")
        ifsc = st.text_input("IFSC Code", value="IOBA0000091")
        upi_id = st.text_input("UPI ID", value="iniyastravels-1@oksbi")
